...
import static bitninja.de.holodatepickerdialog.datepicker.date.SimpleMonthAdapter.CalendarDay;
...
// First right-of-refusal goes the touch exploration helper.
    ...
    protected void initView() {
        ...
        mMonthTitlePaint.setTypeface(Typeface.DEFAULT_BOLD);
        ...
        mMonthDayLabelPaint.setTypeface(Typeface.DEFAULT);
...
// Invalidate cached accessibility information.
    ...
    private void drawMonthDayLabels(Canvas canvas) {
        ...
        for (int i = 0; i < mNumDays; i++) {
            ...
            canvas.drawText(CalendarDatePickerDialog.getDisplayName(mDayLabelCalendar, Calendar.DAY_OF_WEEK, Calendar.SHORT,
