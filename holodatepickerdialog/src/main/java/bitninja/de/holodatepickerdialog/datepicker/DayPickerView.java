...
import bitninja.de.holodatepickerdialog.datepicker.date.DatePickerController;
import bitninja.de.holodatepickerdialog.datepicker.date.DateTimePickerUtils;
import bitninja.de.holodatepickerdialog.datepicker.date.SimpleMonthAdapter;
import bitninja.de.holodatepickerdialog.datepicker.date.SimpleMonthView;

import static bitninja.de.holodatepickerdialog.datepicker.date.SimpleMonthAdapter.*;

/**
 * This displays a list of months in a calendar format with selectable days.
 */
public class DayPickerView extends ListView implements OnScrollListener, CalendarDatePickerDialog.OnDateChangedListener {
