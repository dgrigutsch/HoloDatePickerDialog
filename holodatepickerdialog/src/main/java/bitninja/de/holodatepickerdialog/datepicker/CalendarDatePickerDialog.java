...
import bitninja.de.holodatepickerdialog.datepicker.date.AccessibleDateAnimator;
...
import bitninja.de.holodatepickerdialog.datepicker.date.YearPickerView;
...
// We want to try to vibrate each individual tick discretely.
    ...
    public interface OnDateSetListener {
         ...
         */
        void onDateSet(DialogFragment dialog, int year, int monthOfYear, int dayOfMonth);
    }
